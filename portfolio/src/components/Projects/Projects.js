        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              description="Sarted working on an e-commerce website using React and JSON Server, focusing on enhancing my frontend development and API integration skills."
